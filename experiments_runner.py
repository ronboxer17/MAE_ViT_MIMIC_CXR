...
def main(args):
    ...
    train_dataset = build_mimic_sample(
        transformer_train, train_sample_size, is_train=True
    )
...
if __name__ == "__main__":
    ...
    avb_transforms = [
        key
        for model_transforms in AVAILABLE_TRANSFORMS.values()
        for key in model_transforms.keys()
    ]
    parser.add_argument(
        "--transformer",
        type=str,
        default="mae_with_augmentation_prob_025",
        choices=avb_transforms,
